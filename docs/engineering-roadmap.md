...
- 85 implemented mapper IDs; fifteen board families currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and thirteen local real-ROM smoke profiles.
...
241 and 243 are implemented but do not yet have executable external verification.
