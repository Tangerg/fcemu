...
- 94 implemented mapper IDs; twenty-nine mapper IDs currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and twenty-eight local real-ROM smoke profiles.
...
KS7032), 150 (Sachen SA-015/SA-630), 163 (Nanjing FC-001), 187 (UNL SF3/KOF96), 189 (TXC MMC3),
