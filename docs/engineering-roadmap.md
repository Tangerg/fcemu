...
- 97 implemented mapper IDs; 63 mapper IDs currently have reproducible external or pinned
...
- Browser Canvas, AudioWorklet, keyboard/gamepad/Oeka Kids input, IndexedDB persistence and quick
  saves.
- Checksum-pinned external conformance runners and 61 local real-ROM smoke profiles.
...
The largest compatibility risk is evidence depth, not missing class files. Mappers 8, 13, 15,
17, 32, 41, 48, 67, 72,
73, 74, 76, 78, 82, 83, 86, 88, 89, 92, 93, 94, 95, 113,
