...
- 85 implemented mapper IDs; ten board families currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and eight local real-ROM smoke profiles.
...
241, 242, 243, 245, 246, 248 and 250 are implemented but do not yet all have executable external verification.
