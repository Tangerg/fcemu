...
- 73 implemented mapper IDs; seven board families currently have reproducible external or pinned
...
(Sunsoft-3), 189 (TXC MMC3) and 245 (Waixing F003) were added afterwards from current hardware
documentation and corpus evidence; those post-track additions do not expand scope to every assigned
