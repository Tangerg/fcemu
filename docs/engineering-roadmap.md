...
- 97 implemented mapper IDs; thirty-five mapper IDs currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and thirty-four local real-ROM smoke profiles.
