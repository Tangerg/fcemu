...
|     72 | Jaleco JF-17       | _Pinball Quest_ (Japan, pinned exact JF-17 profile)                    | _Moero!! Pro Tennis_, tracked as expected audio-incomplete                        | Zero-WRAM layout and conflict-masked PRG/CHR rising edges        |
|     73 | Konami VRC3        | _Salamander_ (Japan, pinned exact KONAMI-VRC-3 profile)                | A redistributable 8-bit-IRQ fixture                                               | PRG/WRAM/CHR RAM and active 16-bit cycle IRQ                     |
|     74 | Waixing Type A     | _Di 4 Ci: Ji Qi Ren Da Zhan - Robot War IV_ (pinned local profile)     | _Ji Jia Zhan Shi_                                                                 | Exact CHR `$08/$09` RAM redirects plus MMC3 banking and IRQ      |
...
|    241 | BxROM with WRAM    | _Journey to the West_                                                  | A database-correct NVRAM image; _Edu_ only for banking/LPC protocol evidence      | Conflict-free PRG latch, WRAM/NVRAM, CHR RAM and optional LPC    |
