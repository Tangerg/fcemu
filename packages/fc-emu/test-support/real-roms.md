...
The current profiles cover ten files used during development:
...
not a general compatibility claim for all Mapper 0, 2, 3, 4, 9, 12, 117, 244, 246 or 250 software.
In particular, the Mapper 12 profile exercises the SL-5020B board but not the distinct FFE 4M
submapper-1 board.
