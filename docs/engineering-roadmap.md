...
- 74 implemented mapper IDs; seven board families currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and five local real-ROM smoke profiles.
...
(Sunsoft-3), 74 (Waixing Type A), 189 (TXC MMC3) and 245 (Waixing F003) were added afterwards from
current hardware documentation and corpus evidence; those post-track additions do not expand scope
to every assigned iNES/NES 2.0 number or permit title hashes and guessed board variants. External
`Verified` evidence remains a separate follow-up.
...
78, 79, 80, 82, 83, 85, 87, 88, 89, 90, 91, 93, 94, 95, 96, 97, 99, 112, 113, 118, 119, 140, 152, 180, 184, 185, 189, 206, 225,
227, 228 and 245 are implemented but do not yet all have executable external verification.
