...
- 61 implemented mapper IDs; four board families currently have reproducible external or pinned
...
| Expansion-audio boards   | 19, 24, 26, 85                 | VRC6/VRC7 done; Namco 163 remains             | In progress |
