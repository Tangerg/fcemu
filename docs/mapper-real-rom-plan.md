...
|     12 | Rex Soft/FFE 4M    | _Dragon Ball Z 5_ (local replay, SL-5020B)                             | A NES 2.0 submapper-1 Super Magic Card extraction                                 | MMC3A IRQ, outer CHR halves, language bit and RAM-card startup   |
...
|    117 | Future Media       | _San Guo Zhi IV: Chi Bi Feng Yun_                                      | _Crayon Shin-chan_                                                                | Four PRG/eight CHR windows, mirroring and one-shot A12 IRQ       |
...
|    133 | Sachen SA-72008    | _Jovial Race_ (72-pin release)                                         | Early 60-pin release only for its compatible `$4120` software path                | `$E100` decode, PRG/CHR latch and hardwired mirroring            |
...
|    226 | BMC 42/63/76-in-1  | _Super 42-in-1_                                                        | _63-in-1_ and _76-in-1_ for 1.5/2 MiB chip layouts                                | Seven PRG lines, paired/mirrored mode, CHR protection and reset  |
...
|    240 | C&E/Supertone      | _Jing Ke Xin Zhuan_                                                    | _Sheng Huo Lie Zhuan_ or an independently sourced revision                        | Expansion decode, PRG/CHR data latch and battery WRAM            |
...
|    243 | Sachen SA-020A     | _Honey Peach_ (SA-006)                                                 | _Poker III 5-in-1_ only as a legacy-format smoke, not hardware proof              | ASIC readback, PRG/CHR bit lines and all four nametable layouts  |
...
|    246 | C&E Fong Shen Bang | _封神榜: 伏魔三太子_                                                   | Modified no-encounter/dual-weapon images only as regression diversity             | Four PRG/CHR banks, 2 KiB SRAM and forced-A17 vector aliases     |
