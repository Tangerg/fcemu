...
- 97 implemented mapper IDs; 66 mapper IDs currently have reproducible external or pinned
...
- Browser Canvas, AudioWorklet, keyboard/gamepad/Oeka Kids input, IndexedDB persistence and quick
  saves.
- Checksum-pinned external conformance runners and 65 local real-ROM smoke profiles.
...
48, 67, 72,
73, 74, 76, 78, 82, 83, 86, 89, 92, 93, 94, 95, 113,
