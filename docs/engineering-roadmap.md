...
- 85 implemented mapper IDs; sixteen board families currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and fourteen local real-ROM smoke profiles.
...
113, 114, 115, 118, 119, 133, 140, 152, 180, 182, 184, 185, 189, 206, 225, 226, 227, 228, 241
and 243 are implemented but do not yet have executable external verification.
