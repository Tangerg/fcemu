...
- 97 implemented mapper IDs; thirty-three mapper IDs currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and thirty-two local real-ROM smoke profiles.
