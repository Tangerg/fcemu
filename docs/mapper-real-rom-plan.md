...
|      3 | CNROM              | _Adventure Island_ (USA)                                               | _Hayauchi Super Igo_ for its 2 KiB PRG-RAM board                                  | CHR banks, AND conflicts and optional mirrored RAM               |
|      4 | MMC3               | _Super Mario Bros. 3_ (USA)                                            | _Rad Racer II_ for four-screen wiring                                             | Filtered A12 IRQ, PRG/CHR modes and mirroring                    |
...
|      9 | MMC2/PxROM         | _Mike Tyson's Punch-Out!!_ (USA)                                       | —                                                                                 | Real PPU FD/FE latch transitions and PRG banking                 |
