...
- 97 implemented mapper IDs; forty-one mapper IDs currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and forty local real-ROM smoke profiles.
