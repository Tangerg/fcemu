...
- 97 implemented mapper IDs; 65 mapper IDs currently have reproducible external or pinned
...
- Browser Canvas, AudioWorklet, keyboard/gamepad/Oeka Kids input, IndexedDB persistence and quick
  saves.
- Checksum-pinned external conformance runners and 64 local real-ROM smoke profiles.
