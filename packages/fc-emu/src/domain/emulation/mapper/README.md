...
- `mapper.ts` defines CPU/PPU address-space, data-line drive, CPU expansion decode, CIRAM/ROM
  nametable routing, lifecycle, signal and deterministic-state capabilities.
