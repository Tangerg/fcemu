...
- 97 implemented mapper IDs; 52 mapper IDs currently have reproducible external or pinned
...
- Browser Canvas, AudioWorklet, keyboard/gamepad/Oeka Kids input, IndexedDB persistence and quick
  saves.
- Checksum-pinned external conformance runners and 51 local real-ROM smoke profiles.
...
17, 24, 25, 32, 33, 41, 48, 67, 70, 71, 72,
