...
- 85 implemented mapper IDs; twelve board families currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and ten local real-ROM smoke profiles.
...
241, 242, 243, 245 and 248 are implemented but do not yet all have executable external verification.
