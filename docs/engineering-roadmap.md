...
- 95 implemented mapper IDs; thirty mapper IDs currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and twenty-nine local real-ROM smoke profiles.
