...
- 83 implemented mapper IDs; seven board families currently have reproducible external or pinned
...
Media), 133 (Sachen SA-72008), 189 (TXC MMC3), 226 (BMC 42/63/76-in-1), 240 (C&E/Supertone), 241
