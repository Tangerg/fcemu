...
- 77 implemented mapper IDs; seven board families currently have reproducible external or pinned
...
226 (BMC 42/63/76-in-1), 240 (C&E/Supertone), 242 (Waixing 43272), 243 (Sachen SA-020A) and 245
(Waixing F003) were added afterwards from current hardware documentation
...
226, 227, 228, 240, 242, 243, 245 and 248 are implemented but do not yet all have executable external verification.
