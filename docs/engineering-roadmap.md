...
- 85 implemented mapper IDs; twenty-three board families currently have reproducible external or pinned
...
- Checksum-pinned external conformance runners and twenty-three local real-ROM smoke profiles.
...
140, 152, 180, 184, 185, 206, 225, 227, 228, 241 and 243
